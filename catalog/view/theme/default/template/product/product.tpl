...
<div id="content" ><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <?php } ?>
    <div class="right">
      <div style="margin:8px;"><span style="font-size:16px;"><b><?php echo $heading_title; ?></b></span></div>
     ...
     <div style="margin-left:5px">
      <?php if ($price) { ?>
      <div class="price">
        <?php if ($tax_money_before) { ?>
        <span class="price-tax" style="font-size:14px;margin-left:0px"><?php echo $text_tax_money_before; ?> <?php echo $tax_money_before; ?></span><br />
        <?php } ?>
        <?php if ($tax_money) { ?>
        <span class="price-tax" style="font-size:14px;margin-left:0px;<?php if ($tax_money<=50) { ?>text-decoration:line-through;<?php } ?>"><?php echo $text_tax_money; ?> 
          <?php echo $tax_money; ?></span> <span style="font-size:12px;color:red;"><?php echo $text_tax_money_rat; ?></span><br />
        <?php } ?>
        <?php echo $text_price; ?>
        <?php if (!$special) { ?>
        <?php echo $price; ?><br />
        ...
        <?php } ?>
        <?php if ($tax) { ?>
        <span class="price-tax" style="margin-left:0px"><?php echo $text_tax; ?> <?php echo $tax; ?></span><br />
        <?php } ?> 
        <?php if ($points) { ?>
