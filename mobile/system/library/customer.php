  	...
  	public function login($email, $password) {
		...
		if ($customer_query->num_rows) {
			$this->session->data['customer_id'] = $customer_query->row['customer_id'];	
                        ...
                        //zhangbo
                        $cardifo_query=  $this->db->query("SELECT * FROM " . DB_PREFIX . "card where customer_id='".$customer_query->row['customer_id']."'");
...
/*		echo "UPDATE " . DB_PREFIX . "customer SET payment_method = '".$paymentMethod."'  WHERE customer_id = '" . (int)$this->session->data['customer_id']."'";
		exit;*/
