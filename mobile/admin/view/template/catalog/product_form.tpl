<?php if ($error_warning) { ?>
 <div class="alert alert-error"><?php echo $error_warning; ?><a class="close" data-dismiss="alert">×</a></div>
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-seo"><?php echo $tab_seo_setting; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <?php } ?>
           ...
           <!--   <tr>
                <td><?php echo $entry_tax_money; ?></td>
                <td><input type="text" name="tax_money" value="<?php echo $tax_money; ?>" /> 注意：由人工计算并加入系统。</td>
              </tr>-->
	            <tr>
	              ...
	              <td><input type="hidden" name="image" value="<?php echo $image; ?>" id="image" />
                    ...
                    <tr>
	              <td>&nbsp;&nbsp;商品活动图片:<br><span class="help">点击图片以更换.</span></td>
	              <td><input type="hidden" name="image1" value="<?php echo $image; ?>" id="image1" />
	                <img src="<?php echo $preview1; ?>" alt="" id="preview1" class="image" onclick="image_upload('image1', 'preview1');" /></td>
	            </tr>
	            <tr>
          ...
          <table class="form">
           ...
           <!-- zhangbo edit 增加分类-->
            <tr>
              ...
              <select name="classid">
              	<option value="1" <?php if($classid==1){ echo 'selected="selected"'; } ?> >自贸专区</option>
              	<option value="2" <?php if($classid==2){ echo 'selected="selected"'; } ?>>直邮专区</option>
              	<option value="3" <?php if($classid==3){ echo 'selected="selected"'; } ?>>一般进口</option>
              </select></td>
            </tr>
           ...
           <!-- zhangbo edit 增加栏目-->
            <tr>
              ...
              <select name="columnsid">
              	<option value="1" <?php if($columnsid==1){ echo 'selected="selected"'; } ?> >益健康</option>
              	<option value="2" <?php if($columnsid==2){ echo 'selected="selected"'; } ?>>益生活</option>
              </select></td>
            </tr>
        ...
        <div id="tab-option">
          ...
          <?php $option_value_row = 0; ?>
		  <?php foreach ($product_options as $product_option) { ?>
          <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox'|| $product_option['type'] == 'color' || $product_option['type'] == 'virtual_product' ) { ?>
		  <?php foreach ($product_option['product_option_value'] as $product_option_value) { ?>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="right"><input type="text" class="span1" name="product_discount[<?php echo $discount_row; ?>][quantity]" value="<?php echo $product_discount['quantity']; ?>" size="2" /></td>
