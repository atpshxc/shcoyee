 ...
 <ul class="nav pull-right">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
		     ...
		     <li><a href="http://www.weivp.com/" target="_blank">商业支持</a></li>
		     <li><a href="http://www.weivp.com/" target="_blank">合作洽谈(QQ240176490)</a></li>
		     <li class="divider"></li>
		     <li><a href="http://www.weivp.com/" target="_blank">团队介绍</a></li> 
		 	 <li><a href="http://www.weivp.com/" target="_blank">官方网站</a></li>
		  </ul>
		</li>
		<li class="dropdown">
