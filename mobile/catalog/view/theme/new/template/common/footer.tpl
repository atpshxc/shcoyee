<footer>
  ...
  <li class="ect-box-flex"><a href="<?php echo HTTP_SERVER?>index.php?route=checkout/cart"><i class="ect-icon ect-icon-flow"></i>购物车<span id="cart_total_bottom_menu" class="badge" style="background-color:red">0</span></a></li>
