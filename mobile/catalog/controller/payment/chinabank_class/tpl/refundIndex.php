<?php 
use catalog\controller\payment\chinabank\common\ConfigUtil;
...
<form method="post" action="../api/WebRefundSign.php" id="paySignForm">
    ...
    <ul class="form-wrap" id="J-form-wrap">
        ...
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text" class="" name="tradeNum" value="" autocomplete="off"
        ...
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text" class="" name="tradeDate" value="<?php echo date('Ymd', time());?>" autocomplete="off"
        ...
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text" class="" name="tradeTime" value="<?php echo date('His',time());?>" autocomplete="off"
