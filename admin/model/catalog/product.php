...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		$name='';
		$this->db->query("INSERT INTO " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', tax_money = '" . (float)$data['tax_money'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW(),classid=".(int)$data['classid'].",columnsid=".(int)$data['columnsid']);
		//zhangbo edit 增加分类 在sql中 增加 classid=".(int)$data['class_id']
                //zhangbo edit 增加分类 在sql中 增加 columnsid=".(int)$data['columnsid']
	...
	public function editProduct($product_id, $data) {
		$name='';
		$this->db->query("UPDATE " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', tax_money = '" . (float)$data['tax_money'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW(), classid=".(int)$data['classid'].",columnsid=".(int)$data['columnsid']." WHERE product_id = '" . (int)$product_id . "'");
		//zhangbo edit 增加分类 在sql中 增加 classid=".(int)$data['class_id']
                //zhangbo edit 增加分类 在sql中 增加 columnsid=".(int)$data['columnsid']
	...
	public function getProducts($data = array()) {
		if ($data) {
			...
			if (isset($data['filter_tax_money']) && !is_null($data['filter_tax_money'])) {
				$sql .= " AND p.tax_money LIKE '" . $this->db->escape($data['filter_tax_money']) . "%'";
			}
