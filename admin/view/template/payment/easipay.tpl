    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
		...
		<td><span class="required">*</span> <?php echo $entry_trade_type; ?><br></td>
          <td>
			直接到帐:&nbsp;<input type="radio" name="easipay_cmdno" value="1"  checked="true"/>&nbsp;&nbsp;
		</td>
        </tr>
		<tr>
          <td><span class="required">*</span> <?php echo $entry_key; ?></td>
          <td><input type="text" name="easipay_key" value="<?php echo $easipay_key; ?>" size="50" />
	 		 <?php if ($error_key) { ?>
		...
		<tr>
          ...
          <td><input type="text" name="easipay_bargainor_id" value="<?php echo $easipay_bargainor_id; ?>" size="50" />
        ...
        <tr>
          ...
          <td><select name="easipay_order_status_id">
              <?php foreach ($order_statuses as $order_status) { ?>
              <?php if ($order_status['order_status_id'] == $easipay_order_status_id) { ?>
        ...
        <tr>
          ...
          <td><select name="easipay_status">
              <?php if ($easipay_status) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="easipay_sort_order" value="<?php echo $easipay_sort_order; ?>" size="1" /></td>
        </tr>
		 <tr>
          <td>&nbsp;</td>
