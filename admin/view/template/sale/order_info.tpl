    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content" >
        <table class="form">
		  ...
		  <tr>
            ...
            <td id="order-status"><?php echo $payment_method; ?></td>
          </tr>
          <?php } ?>
          <?php if ($comment) { ?>
          <tr>
      ...
      <div id="tab-history" class="vtabs-content">
        <div id="history"></div>
          ...
          <tr>
            <td><?php echo $text_express_no;?></td>
            <td><input type="text" name="express_no" value="" /></td>
          </tr>
          <?php } ?>
...
function history() {
	$.ajax({
		...
		dataType: 'html',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) +'&express=' + encodeURIComponent($('select[name=\'express\']').val()) + '&notify=' + encodeURIComponent($('input[name=\'notify\']').attr('checked') ? 1 : 0) + '&append=' + encodeURIComponent($('input[name=\'append\']').attr('checked') ? 1 : 0) + '&express_no=' + encodeURIComponent($('input[name=\'express_no\']').val())+ '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
